        ...
        <div class="column is-narrow" style="background-color: #79D159; min-height: 100vh; padding: 0;">
            <aside class="menu" style="padding: 25px; width: 200px;">
                <ul class="menu-list">
                    ...
                    <hr>
                    <li>
                        <a href="#" style="background-color: #55B537; color: white;">商品登録</a>
                    </li>
                    <hr>
                    <li>
                        ...
                        <div class="level">
                            ...
                            <div class="level-right">
                                ...
                                <div>
                                    ...
                                    <input type="text" v-model="time" name="start_time" placeholder="00:00" size="5"
                                        required>～
                                    ...
                                    <div class="block">
                                        ...
                                        <div class="level">
                                            ...
                                            <div class="level-right">
                                                <div>
                                                    <div>
                                                        <input type="text" v-model="addressNum" name="post-code"
                                                            placeholder="000-0000" size="8" required>
                                        ...
                                        <div class="level">
                                            ...
                                            <div class="level-right">
                                                <div>
                                                    <textarea v-model="detail" name="detail" cols="25" rows="5"
                                                        max="1000" placeholder="※1000文字以内で入力してください" required></textarea>
                                                    <p class="help">{{ detail.length }}/ 1000 <span v-if="isDetailOver">
                                                            <font color="red">※文字数が超過しています</font>
                                                        </span> </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="level-right">
                                                <div>
                                                    ...
                                                    <?php if (isset($_GET['failed'])): ?>
                                                        <p class="help is-danger">ファイルはpng、またはjpegを指定してください</p>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="level">
                                            ...
                                            <div class="level-right">
                                                <input type="number" v-model="price" min="0" size="5" name="price"
                                                    required>円
                                            </div>
                                        </div>

...
<div class="level-item">
    <form class="box" style="width: 520px; text-align: center;" action="user-logout-action.php" method="post">
        ...
        <div class="field has-text-centered" style="margin-top: 2rem;">
            <a href="index.php" class="button is-light is-medium" style="margin-right: 20px;">戻る</a>
